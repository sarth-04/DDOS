...
try:
    ...
    print("pip install pandas numpy scikit-learn gymnasium stable-baselines3 matplotlib seaborn")
    exit()
...
def evaluate_and_visualize(model, X_test, y_test):
    ...
    plot_confusion_matrix(y_test[:len(predictions)], predictions)
